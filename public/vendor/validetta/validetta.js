...
;(function( $ ) {
  ...
  defaults = {
    ...
    onValid : function(){}, // This function to be called when the user administrator submits the form and there is no error.
    onError : function(){}, // This function to be called when the user administrator submits the form and there are some errors
