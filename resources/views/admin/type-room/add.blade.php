...
@section('content')
    <div class="box box-solid flat">
        <div class="box-body">
            ...
            <hr>
            <form action="{{ route('admin.type-room.store') }}" method="post" id="form"
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="name" class="form-control" data-validetta="required" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                        ...
                        <div class="col-sm-6">
                            <textarea name="description" class="form-control" rows="10" data-validetta="required" autocomplete="off"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="price" class="form-control" data-validetta="required,number" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
