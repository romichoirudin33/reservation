...
@section('content')
    <div class="box box-solid flat">
        <div class="box-body">
            ...
            <hr>
            <form action="{{ route('admin.facility.update', ['id' => $data->id]) }}" method="post" id="form"
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="name" class="form-control" data-validetta="required" value="{{ $data->name }}">
                        </div>
                    </div>
                    <div class="form-group">
